...
export const DEFAULT_MTD_COLS = [
  ...
  "coaching_completion_pct", "ontime_coaching_pct", "crm_pct_coaching_on_time", "jkq_score", "jkq_result", "jkq_episode",
...
export const COL_LABELS = {
  ...
  ontime_coaching_pct: "On-time coaching %", crm_pct_coaching_on_time: "CRM on-time %", jkq_score: "JKQ score", jkq_result: "JKQ result", jkq_episode: "JKQ episode",
