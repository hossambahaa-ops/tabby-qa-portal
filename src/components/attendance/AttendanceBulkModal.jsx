    ...
    <Modal onClose={onClose} maxWidth={520} padding={20} title="Bulk set attendance">
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
          <button
            ...
            style={{ fontSize: 11, background: bulkStatus === "P" && bulkDayFilter === "weekdays" ? "var(--green)" : "var(--green-bg)", color: bulkStatus === "P" && bulkDayFilter === "weekdays" ? "#fff" : "var(--green)", border: "1px solid var(--green)", fontWeight: 600, transition: "all .15s" }}
          ...
          <button
            className="btn btn-sm"
            style={{ fontSize: 11, background: bulkStatus === "OFF" && bulkDayFilter === "weekends" ? "var(--tx2)" : "rgba(156,163,175,0.1)", color: bulkStatus === "OFF" && bulkDayFilter === "weekends" ? "var(--bg3)" : "var(--tx2)", border: "1px solid var(--bd)", fontWeight: 600, transition: "all .15s" }}
